          ...
          <div className="row">
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-6">
                  Hero: 222, Tehran,Iran,Sepideh Jonobi.
                  <br />
                  Shahrake Valiasr. <br />
                  PinCode: 1375696183
                </address>
                <a
                  href="tel:+989361453542"
                  className="mt-3 text-white d-block mb-1"
                >
                  +989361453542
                </a>
                <a
                  href="mailto:ali.zarchini1367@gmail.com"
            ...
            <div className="col-3">
              ...
              <div className="footer-links d-flex flex-column">
                ...
                <Link to="shopping-policy" className="text-white py-2 mb-1">
                  Shopping Policy
                </Link>
                <Link
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy; {new Date().getUTCFullYear()}; Powered by Developer's Ali
                Zarchini
              </p>
            </div>
          </div>
